...
// Шаблон вектора
template <class ValType> class TVector
{
protected:
	ValType *pVector;
...
{
	TVector z(Size, StartIndex);
	for (int i = 0; i < Size; i++)
		z.pVector[i] = pVector[i] + val;
	return z;
} /*-------------------------------------------------------------------------*/
...
TVector<ValType> TVector<ValType>::operator+(const TVector<ValType> &v)
{
	...
	TVector z(Size, StartIndex);
	for (int i = 0; i <Size; i++)
		z.pVector[i] = this->pVector[i] + v.pVector[i];
	return z;
} /*-------------------------------------------------------------------------*/
...
ValType TVector<ValType>::operator*(const TVector<ValType> &v)
{
	...
	ValType F = 0;
	for (int i = 0; i < Size; i++) {
		F = F + (this->pVector[i] * v.pVector[i]);
	}
	return F;
} /*-------------------------------------------------------------------------*/
